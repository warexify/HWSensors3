...
IOService* AmdCPUMonitor::probe(IOService *provider, SInt32 *score)
{
	...
	if (OSDictionary * dictionary = serviceMatching(kGenericPCIDevice)) {
		if (OSIterator * iterator = getMatchingServices(dictionary)) {
            ...
            ((vendor_id==0x1022) && (device_id== 0x1463))){ //Risen
...
IOReturn AmdCPUMonitor::callPlatformFunction(const OSSymbol *functionName, bool waitForFunction, void *param1, void *param2, void *param3, void *param4 )
{
//	UInt16 t;
  UInt32 value=0;
